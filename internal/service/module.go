...
// ModuleService implements the v1 ModuleService interface by wrapping Service.
type ModuleService struct {
	svc *Service
}

// NewModuleService creates a new v1 ModuleService wrapper.
func NewModuleService(svc *Service) *ModuleService {
	return &ModuleService{svc: svc}
}

// GetModules retrieves modules by id or name (v1 API).
func (m *ModuleService) GetModules(ctx context.Context, req *connect.Request[v1.GetModulesRequest]) (*connect.Response[v1.GetModulesResponse], error) {
	if m.svc.casReg == nil {
...
func (m *ModuleService) getModuleByID(ctx context.Context, id string) (*v1.Module, error) {
...
func (m *ModuleService) getModuleByName(ctx context.Context, owner, name string) (*v1.Module, error) {
...
func (m *ModuleService) ListModules(ctx context.Context, req *connect.Request[v1.ListModulesRequest]) (*connect.Response[v1.ListModulesResponse], error) {
	if m.svc.casReg == nil {
		return nil, connect.NewError(connect.CodeUnimplemented, errors.New("CAS storage not configured"))
	}
...
func (m *ModuleService) CreateModules(ctx context.Context, req *connect.Request[v1.CreateModulesRequest]) (*connect.Response[v1.CreateModulesResponse], error) {
	if m.svc.casReg == nil {
		return nil, connect.NewError(connect.CodeUnimplemented, errors.New("CAS storage not configured"))
	}
...
func (m *ModuleService) UpdateModules(ctx context.Context, req *connect.Request[v1.UpdateModulesRequest]) (*connect.Response[v1.UpdateModulesResponse], error) {
	if m.svc.casReg == nil {
		return nil, connect.NewError(connect.CodeUnimplemented, errors.New("CAS storage not configured"))
	}
...
func (m *ModuleService) DeleteModules(ctx context.Context, req *connect.Request[v1.DeleteModulesRequest]) (*connect.Response[v1.DeleteModulesResponse], error) {
	if m.svc.casReg == nil {
		return nil, connect.NewError(connect.CodeUnimplemented, errors.New("CAS storage not configured"))
	}
