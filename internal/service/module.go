...
func (reg *Service) ListModules(_ context.Context, _ *connect.Request[v1.ListModulesRequest]) (*connect.Response[v1.ListModulesResponse], error) {
...
func (reg *Service) CreateModules(_ context.Context, _ *connect.Request[v1.CreateModulesRequest]) (*connect.Response[v1.CreateModulesResponse], error) {
...
func (reg *Service) UpdateModules(_ context.Context, _ *connect.Request[v1.UpdateModulesRequest]) (*connect.Response[v1.UpdateModulesResponse], error) {
...
func (reg *Service) DeleteModules(_ context.Context, _ *connect.Request[v1.DeleteModulesRequest]) (*connect.Response[v1.DeleteModulesResponse], error) {
