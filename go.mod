module github.com/greatliontech/pbr

go 1.25.0

require (
	buf.build/gen/go/bufbuild/buf/connectrpc/go v1.19.1-20260120193120-196690b960be.2
	buf.build/gen/go/bufbuild/buf/protocolbuffers/go v1.36.11-20260120193120-196690b960be.1
	...
	github.com/greatliontech/ocifs v0.1.2
